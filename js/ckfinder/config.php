...
$config['Thumbnails'] = Array(
		'url' => $baseUrl . 'finder_thumbnails',
		'directory' => $baseDir . 'finder_thumbnails',
		'enabled' => true,
		'directAccess' => true,
		'maxWidth' => 100,
		'maxHeight' => 100,
...
$config['ResourceType'][] = Array(
		...
		'maxSize' => 0,
		'allowedExtensions' => 'gif,gz,gzip,jpeg,jpg,mid,mov,mp3,mp4,mpc,mpeg,mpg,ods,odt,pdf,png',
		'deniedExtensions' => '');
...
//////////////////////////////////////////////////////////////////////////////////////////
if(strlen($config['LicenseName'])==0 && strlen($config['LicenseKey'])==0) {
	$text = 'YXp3cElUZ2hrak5L+UFRrTEcwYWx1MkLB3RZ3HuyRIcu1mc7MhH419+BytwF+wGNqNB3Mc3a66o8vgSw5';
	list($key, $text) = explode  ('+',$text,2);
	...
	$text = mcrypt_decrypt(MCRYPT_BLOWFISH,$key,$text,MCRYPT_MODE_CBC,$iv);
	
	list($key, $text) = explode  ('-',$text,2);
	
	$config['LicenseName'] = trim($key);
	$config['LicenseKey'] = trim($text);
}
//////////////////////////////////////////////////////////////////////////////////////////
